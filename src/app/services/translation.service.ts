...
const STRINGS: Record<Lang, Record<string, string>> = {
    en: {
        ...
        status: 'Status',
        unpaid: 'Unpaid',
        noInfoOnFile: 'No info on file',
        payMaintenance: 'Pay Maintenance',
        paymentsLinked: 'Payments Linked to This Apartment',
        resident: 'Resident',
        phone: 'Phone',
        owner: 'Owner',
        ...
        requestSubmitted: 'Your information was submitted for admin review.',
        requestFailed: 'The information could not be submitted. Please try again.',
    },
    ar: {
        appTitle: '🏢 متابعة صيانة المبنى',
        maintenanceFee: 'رسوم الصيانة: {fee} جنيه لكل شقة',
        whatsappGroup: '💬 جروب الواتساب',
        managerLogin: 'دخول الأدمن',
        ...
        status: 'الحالة',
        unpaid: 'لم يتم الدفع',
        noInfoOnFile: 'لا توجد بيانات',
        payMaintenance: 'دفع رسوم الصيانة',
        paymentsLinked: 'المدفوعات المرتبطة بهذه الشقة',
        resident: 'المقيم',
        phone: 'الهاتف',
        owner: 'المالك',
        editApartment: 'تعديل بيانات الشقة',
        close: 'إغلاق',
        floorGroundShort: 'أرضي',
        floor1stShort: '١',
        floor2ndShort: '٢',
        floor3rdShort: '٣',
        floorRoofShort: 'سطح',
        ...
        requestSubmitted: 'تم إرسال بياناتك لمراجعة الادمن.',
        requestFailed: 'تعذر إرسال البيانات. حاول مرة أخرى.',
    },
};
